...
/**
 * Array of 365 kid-friendly daily messages that all imply "Who's ready for chores?"
 * Each message is unique for every day of the year.
 */
const DAILY_MESSAGES = [
  "Time to shine! Who wants to help?",
  "Let's make today amazing together!",
  "Ready to be a super helper?",
  "Who's excited to tackle some tasks?",
  "Let's get things done!",
  "Time to show what you can do!",
  "Who wants to earn some stars today?",
  "Let's be awesome together!",
  "Ready to make a difference?",
  "Who's pumped to help out?",
  "Let's have a productive day!",
  "Time to be a team player!",
  "Who's up for some action?",
  "Let's accomplish great things!",
  "Ready to be a champion?",
  "Who wants to make magic happen?",
  "Time to rock and roll!",
  "Let's make our home sparkle!",
  ...
  "Ready to be outstanding?",
  "Time to make it happen!",
  "Let's be productive!",
  "Who's excited for today?",
  "Ready to show teamwork?",
  "Time to be helpful!",
  "Let's make things shine!",
  ...
  "Ready to make it awesome?",
  "Time to be active!",
  "Let's have a great day!",
  "Who wants to join in?",
  "Ready to be a helper?",
  "Time to get cooking!",
  ...
  "Time to be diligent!",
  "Let's work cheerfully!",
  "Who wants to assist?",
  "Ready to be thorough?",
  "Time to show pride!",
  ...
  "Ready to be attentive?",
  "Time to take part!",
  "Let's get tasks done!",
  "Who's feeling awesome?",
  "Ready to be involved?",
  "Time to be participative!",
  "Let's show responsibility!",
  "Who wants to excel?",
  "Ready to be committed?",
  "Time to help willingly!",
  "Let's be contributing!",
  "Who's ready to engage?",
  "Ready to be focused?",
  "Time to show kindness!",
  "Let's work together nicely!",
  "Who wants to achieve?",
  "Ready to be determined?",
  "Time to help happily!",
  "Let's be enthusiastic!",
  "Who's feeling ready?",
  "Ready to be persistent?",
  "Time to work smart!",
  "Let's make it happen today!",
  "Who wants to thrive?",
  "Ready to be clever?",
  "Time to help out now!",
  "Let's be industrious!",
  "Who's ready to prosper?",
  "Ready to be conscientious?",
  "Time to be dependable!",
  "Let's show teamwork!",
  "Who wants to flourish?",
  "Ready to be steadfast?",
  "Time to help eagerly!",
  "Let's be devoted!",
  "Who's feeling inspired?",
  "Ready to be zealous?",
  "Time to work joyfully!",
  "Let's make progress now!",
  "Who wants to advance?",
  "Ready to be spirited?",
  "Time to help cheerfully!",
  "Let's be vigorous!",
  "Who's ready to improve?",
  "Ready to be lively?",
  "Time to show passion!",
  "Let's work with heart!",
  "Who wants to grow?",
  "Ready to be animated?",
  "Time to help keenly!",
  "Let's be dynamic!",
  "Who's feeling driven?",
  "Ready to be ambitious?",
  "Time to work earnestly!",
  "Let's accomplish more!",
  "Who wants to develop?",
  "Ready to be purposeful?",
  "Time to help actively!",
  "Let's be effective!",
  "Who's ready to succeed?",
  "Ready to be resourceful?",
  "Time to show talent!",
  "Let's work brilliantly!",
  "Who wants to perform?",
  "Ready to be capable today?",
  "Time to help strongly!",
  "Let's be proficient!",
  "Who's feeling confident?",
  "Ready to be competent?",
  "Time to work well!",
  "Let's make it great!",
  "Who wants to deliver?",
  "Ready to be adept?",
  "Time to help expertly!",
  "Let's be skilled!",
  "Who's ready to execute?",
  "Ready to be accomplished?",
  "Time to show ability!",
  "Let's work capably!",
  "Who wants to complete?",
  "Ready to be qualified?",
  "Time to help proficiently!",
  "Let's be talented!",
  "Who's feeling able?",
  "Ready to be gifted?",
  "Time to work expertly!",
  "Let's show competence!",
  "Who wants to finish?",
  "Ready to be practiced?",
  "Time to help ably!",
  "Let's be masterful!",
  "Who's ready to fulfill?",
  "Ready to be polished?",
  "Time to show prowess!",
  ...
  "Time to work impressively!",
  "Let's show excellence!",
  "Who wants to perfect?",
  "Ready to be extraordinary?",
  "Time to help remarkably!",
  "Let's be exceptional!",
  "Who's ready to distinguish?",
  "Ready to be distinguished?",
  "Time to show distinction!",
  "Let's work notably!",
  "Who wants to stand out?",
  "Ready to be notable?",
  "Time to help notably!",
  "Let's be noteworthy!",
  "Who's feeling special?",
  "Ready to be memorable?",
  "Time to work memorably!",
  "Let's show memorability!",
  "Who wants to impress?",
  "Ready to be striking?",
  "Time to help strikingly!",
  "Let's be significant!",
  "Who's ready to matter?",
  "Ready to be important?",
  "Time to show importance!",
  "Let's work importantly!",
  "Who wants to count?",
  "Ready to be valuable?",
  "Time to help valuably!",
  "Let's be worthwhile!",
  "Who's feeling worthwhile?",
  "Ready to be beneficial?",
  "Time to work beneficially!",
  "Let's show benefit!",
  "Who wants to serve?",
  "Ready to be serviceable?",
  "Time to help serviceably!",
  "Let's be instrumental!",
  "Who's ready to aid?",
  "Ready to be advantageous?",
  "Time to show advantage!",
  "Let's work advantageously!",
  "Who wants to benefit?",
  "Ready to be constructive?",
  "Time to help constructively!",
  "Let's be fruitful!",
  "Who's feeling fruitful?",
  "Ready to be profitable?",
  "Time to work profitably!",
  "Let's show profit!",
  "Who wants to gain?",
  "Ready to be gainful?",
  "Time to help gainfully!",
  "Let's be rewarding!",
  "Who's ready to reward?",
  "Ready to be satisfying?",
  "Time to show satisfaction!",
  "Let's work satisfyingly!",
  "Who wants to please?",
  "Ready to be pleasing?",
  "Time to help pleasingly!",
  "Let's be gratifying!",
  "Who's feeling gratified?",
  "Ready to be fulfilling?",
  "Time to work fulfillingly!",
  "Let's show fulfillment!",
  "Who wants to fulfill?",
  "Ready to be enriching?",
  "Time to help enrichingly!",
  "Let's be uplifting!",
  "Who's ready to uplift?",
  "Ready to be inspiring?",
  "Time to show inspiration!",
  "Let's work inspiringly!",
  "Who wants to motivate?",
  "Ready to be motivating?",
  "Time to help motivatingly!",
  "Let's be encouraging!",
  "Who's feeling encouraged?",
  "Ready to be heartening?",
  "Time to work hearteningly!",
  "Let's show heart!",
  "Who wants to hearten?",
  "Ready to be invigorating?",
  "Time to help invigoratingly!",
  "Let's be stimulating!",
  "Who's ready to stimulate?",
  "Ready to be exciting?",
  "Time to show excitement!",
  "Let's work excitingly!",
  "Who wants to excite?",
  "Ready to be thrilling?",
  "Time to help thrillingly!",
  "Let's be exhilarating!",
  "Who's feeling exhilarated?",
  "Ready to be electrifying?",
  "Time to work electrifyingly!",
  "Let's show electricity!",
  "Who wants to electrify?",
  "Ready to be galvanizing?",
  "Time to help galvanizingly!",
  "Let's be rousing!",
  "Who's ready to rouse?",
  "Ready to be stirring?",
  "Time to show spirit!",
  "Let's work spiritedly!",
  "Who wants to stir up good?",
  "Ready to be moving?",
  "Time to help movingly!",
  "Let's be touching!",
  "Who's feeling touched?",
  "Ready to be affecting?",
  "Time to work affectingly!",
  "Let's show affection!",
  "Who wants to affect positively?",
  "Ready to be impactful?",
  "Time to help impactfully!",
  "Let's be influential!",
  "Who's ready to influence?",
  "Ready to be powerful today?",
  "Time to show power!",
  "Let's work powerfully!",
  "Who wants to empower?",
  "Ready to be empowering?",
  "Time to help empoweringly!",
  "Let's be strengthening!",
  "Who's feeling strengthened?",
  "Ready to be fortifying?",
  "Time to work fortifyingly!",
]

/**
 * Gets a unique daily message based on the day of the year.
 * Returns a kid-friendly message that implies "Who's ready for chores?"
 * Each day of the year (1-365/366) gets a unique message.
 * 
 * @param date - Optional date to get message for (defaults to today)
 * @returns A kid-friendly daily message
 */
export function getDailyChoreMessage(date: Date = new Date()): string {
  ...
  // Use modulo to cycle through messages (handles leap years gracefully)
  const messageIndex = (dayOfYear - 1) % DAILY_MESSAGES.length
