...
const TABLE_CONFIGS: Record<string, TenantTableConfig> = {
  ...
  rewards: {
    ...
    createSql: `CREATE TABLE IF NOT EXISTS tenant_rewards_v2 (
      ...
      swap_config JSON,
      inactive_on_school_holidays TINYINT(1) DEFAULT 0,
      only_on_school_holidays TINYINT(1) DEFAULT 0,
      holiday_cost_override INT NULL,
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
      updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
      PRIMARY KEY (tenant_id, id),
      FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
  ...
  'point-swaps': {
    ...
    createSql: `CREATE TABLE IF NOT EXISTS tenant_point_swaps_v2 (
      ...
      from_category_id VARCHAR(36),
      to_category_id VARCHAR(36),
      from_amount INT DEFAULT 0,
      to_amount INT DEFAULT 0,
      points INT DEFAULT 0,
